...
void main() {
  ...
  test('personal sign 3', () {
    ...
    final sign = privateKey.signPersonalMessage(
      messagae,
      useEthereumPrefix: true,
    );
    final verify = privateKey.publicKey().verifyPersonalMessage(
      messagae,
      sign,
      useEthereumPrefix: true,
    );
    expect(verify, true);
    final publicKey = TronPublicKey.fromPersonalSignature(
      messagae,
      sign,
      useEthereumPrefix: true,
    );
  ...
  test('personal sign 5', () {
    ...
    final List<int> hashedMessage = QuickCrypto.keccack256Hash([
      ...prefixBytes,
      ...messagae,
    ]);
    final verify = privateKey.publicKey().verifyPersonalMessage(
