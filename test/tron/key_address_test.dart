...
void main() {
  test('keys 1', () {
    ...
    expect(
      publicKey.toHex(mode: PubKeyModes.uncompressed).toUpperCase(),
    ...
    expect(
      address.toAddress(false).toUpperCase(),
      '41FF8BA1FACC3D11FE98FCE25010317004ADF4961A',
    );
    expect(
      address,
      TronAddress.deserializeIAddress(bytes: address.encodeAsIAddress()),
    );
  });
  test('keys 2', () {
    final privateKey = TronPrivateKey(
