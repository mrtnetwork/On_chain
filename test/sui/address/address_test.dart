...
void _ed25519() {
  test("address ed25519", () {
    final suiPrivateKey = SuiED25519PrivateKey.fromBytes(
    ...
    expect(
      address,
      SuiAddress.deserializeIAddress(bytes: address.encodeAsIAddress()),
    );
  });
}
...
void _secp256k1() {
  test("address Secp256k1", () {
    final suiPrivateKey = SuiSecp256k1PrivateKey.fromBytes(
      List<int>.filled(32, 12),
    );
    final address = suiPrivateKey.publicKey.toAddress();
    expect(
...
void _secp256r1() {
  test("address Secp256r1", () {
    final suiPrivateKey = SuiSecp256r1PrivateKey.fromBytes(
      List<int>.filled(32, 12),
    );
    final address = suiPrivateKey.publicKey.toAddress();
    expect(
