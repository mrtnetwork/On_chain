...
void _createAddress2() {
  test("create Multisig Address", () {
    final multisigPubkey = SuiMultisigAccountPublicKey(
      publicKeys: [
    ...
    final decode = SuiMultisigAccountPublicKey.deserialize(
      StringUtils.encode(
        "AwIDQq2XHQN9GrK+384/F/l9utEgXqfMdaBP9YLdylagvzgEAgP3+Ff1FiAh1OkfZYQ2bmm3fbp5AQYFrFxQe1E4lR/CQgUCAm0Thf+syb1IULdQ2hfAY0MrzbUj2Q7Jz5JQulob0wZjCQkA",
    ...
    expect(
      BytesUtils.toHexString(decode.toVariantBcs()),
    ...
    final multisigPubkey = SuiMultisigAccountPublicKey(
      publicKeys: [
        ...
        SuiMultisigPublicKeyInfo(
          publicKey: getPublicKeySecp256k1(14),
          weight: 2,
        ),
