...
void _outputs() {
  test('legacy with data hash', () {
    ...
    final newBytes =
        CborListValue.definite(
          decodeTxos.map((e) => e.toCbor()).toList(),
        ).encode();
  ...
  test('script ref', () {
    ...
    final txo2 = TransactionOutput(
      ...
      address: address,
      amount: Value(coin: BigInt.from(435464757)),
      scriptRef: ScriptRefPlutusScript(
        PlutusScript(
  ...
  test('alonzo with native script', () {
    ...
    final txo2 = TransactionOutput(
      ...
      address: address,
      amount: Value(coin: BigInt.from(435464757)),
      scriptRef: ScriptRefNativeScript(
        NativeScriptTimelockStart(BigInt.from(20)),
      ),
      plutusData: DataOptionData(
        PlutusBytes(
          value: [
