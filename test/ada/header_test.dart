...
void _moveInstantaneousReward() {
  test('MoveInstantaneousReward', () {
    MoveInstantaneousReward reservesToPot = MoveInstantaneousReward(
      pot: MIRPot.treasury,
      variant: ToOtherPot(BigInt.from(143546464)),
    );
    expect(reservesToPot.serializeHex(), '82011a088e5860');
    MoveInstantaneousReward decode = MoveInstantaneousReward.fromCborBytes(
      reservesToPot.serialize(),
    );
    expect(decode.serialize(), reservesToPot.serialize());
    reservesToPot = MoveInstantaneousReward(
      pot: MIRPot.treasury,
      variant: ToOtherPot(BigInt.zero),
    );
    ...
    final stake = MIRToStakeCredentials({
      CredentialScript(List<int>.filled(28, 54)): BigInt.from(-314159265),
    });
    reservesToPot = MoveInstantaneousReward(
      pot: MIRPot.treasury,
      variant: stake,
...
void _headerBody() {
  ...
  test('HeaderBody_2', () {
    final headerBody = HeaderBody(
      ...
      leaderCert: HeaderLeaderCertVrfResult(
        VRFCert(output: _fakeBytes32(3), proof: List<int>.filled(80, 0)),
      ),
      operationalCert: OperationalCert(
        hotVkey: KESVKey(_fakeBytes32(5)),
        sequenceNumber: 123,
    ...
    expect(
      headerBody.serializeHex(),
      '',
    );
