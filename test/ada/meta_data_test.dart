...
String _encodeDecodeCheck(
  List<PlutusScript> scripts, {
  AuxiliaryDataCborEncoding encoding = AuxiliaryDataCborEncoding.conwayEra,
}) {
  final metadata = GeneralTransactionMetadata(
    metadata: {
...
void _auxiliaryData() {
  test('AuxiliaryData', () {
    final gmd = GeneralTransactionMetadata(
      metadata: {
  ...
  test('TransactionMetadata_1', () {
    ...
    final plutusV1 = PlutusScript.deserialize(
