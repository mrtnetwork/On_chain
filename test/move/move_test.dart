...
void _test() {
  test("MoveVector serialization", () {
    ...
    expect(
      type.toBcs(),
      LayoutConst.bcsVector(LayoutConst.u8()).serialize([1]),
    );
    ...
    expect(
      type.toBcs(),
      LayoutConst.bcsVector(LayoutConst.bcsString()).serialize(["MRTNETWORK"]),
    );
    type = MoveVector([MoveOption(MoveString("MRTNETWORK"))]);
    expect(
      type.toBcs(),
      LayoutConst.bcsVector(
        LayoutConst.optional(LayoutConst.bcsString()),
  ...
  test("MoveString serialization", () {
    ...
    expect(
      () => MoveString.parse(false),
      throwsA(TypeMatcher<BcsSerializationException>()),
    );
    expect(
      () => MoveString.parse(true),
      throwsA(TypeMatcher<BcsSerializationException>()),
    );
  });
  ...
  test("MoveVecOption serialization", () {
    ...
    expect(
      type.toBcs(),
      LayoutConst.optional(LayoutConst.u8()).serialize(null),
    );
    ...
    expect(
      () => MoveOption(MoveU32((BigInt.one << 32).toInt())),
      throwsA(TypeMatcher<BcsSerializationException>()),
    );
    ...
    expect(
      type.toBcs(),
      LayoutConst.optional(
        LayoutConst.bcsVector(LayoutConst.u128()),
