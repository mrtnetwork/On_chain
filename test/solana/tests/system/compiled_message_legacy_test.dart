...
void _systemCreateAccount() {
  test('create', () {
    ...
    final decodeTransaction = SolanaTransaction.deserialize(
...
void _systemCreateAccountWithSeed() {
  test('createWithSeed', () {
    ...
    final ownerSignature = owner.privateKey.sign(
...
void _nonceInitialize() {
  test('nonceInitialize', () {
    ...
    final layout = SystemInitializeNonceAccountLayout(
      authorized: owner.address,
    );
