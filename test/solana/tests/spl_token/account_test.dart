...
void _transferConfigAccount() {
  test('transfer confing ', () {
    ...
    final account = TransferFeeConfig.fromBuffer(
      BytesUtils.fromHexString(data),
    );
    expect(
      account.transferFeeConfigAuthority.address,
      '7L88T2bagkBNcSvazPPL3QzLeZff9C94f89iT375mMeH',
    );
    expect(
      account.withdrawWithheldAuthority.address,
      '7L88T2bagkBNcSvazPPL3QzLeZff9C94f89iT375mMeH',
    );
