...
const _owner = SolAddress.unchecked(
...
void _addCardToPack() {
  test('addCardToPack', () {
    const layout = MetaplexNFTPacksAddCardToPackLayout(
      addCardToPack: AddCardToPack(maxSupply: 1, weight: 0, index: 3),
    );
    expect(layout.toHex(), '0101000000000003000000');
    final decode = MetaplexNFTPacksAddCardToPackLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _addVoucherToPack() {
  test('addVoucherToPack', () {
    ...
    final decode = MetaplexNFTPacksAddVoucherToPackLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _deactivate() {
  test('deactivate', () {
    ...
    final decode = MetaplexNFTPacksDeactivateLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _deletePack() {
  test('deletePack', () {
    ...
    final decode = MetaplexNFTPacksDeletePackLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _deletePackCard() {
  test('deletePackCard', () {
    ...
    final decode = MetaplexNFTPacksDeletePackCardLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _deletePackConfig() {
  test('deletePackConfig', () {
    ...
    final decode = MetaplexNFTPacksDeletePackConfigLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _deletePackVoucher() {
  test('deletePackVoucher', () {
    ...
    final decode = MetaplexNFTPacksDeletePackVoucherLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _requestCardForRedeem() {
  test('requestCardForRedeem', () {
    ...
    final decode = MetaplexNFTPacksRequestCardForRedeemLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
