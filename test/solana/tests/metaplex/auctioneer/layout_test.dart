...
void _authorize() {
  test('authorize', () {
    ...
    final decode = MetaplexAuctioneerAuthorizeLayout.fromBuffer(
      layout.toBytes(),
    );
...
void _cancel() {
  test('cancel', () {
    ...
    expect(
      layout.toHex(),
      'e8dbdf29dbecdcbe64b3b5560700000000fa93be0101000000',
    );
...
void _executeSale() {
  test('executeSale', () {
    ...
    final decode = MetaplexAuctioneerExecuteSaleLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _withdraw() {
  test('withdraw', () {
    ...
    final decode = MetaplexAuctioneerWithdrawLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
