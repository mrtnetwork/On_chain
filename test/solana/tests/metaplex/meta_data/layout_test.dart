...
void _createV1() {
  test('createV1', () {
    ...
    final decode = MetaplexTokenMetaDataCreateV1Layout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _bubblegumSetCollectionSize() {
  test('bubblegumSetCollectionSize', () {
    final layout = MetaplexTokenMetaDataBubblegumSetCollectionSizeLayout(
      size: BigInt.one,
    );
...
void _burnV1() {
  test('burnV1', () {
    ...
    final decode = MetaplexTokenMetaDataBurnV1Layout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _update() {
  test('updateV1', () {
    ...
    final decode = MetaplexTokenMetaDataUpdateV1Layout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
  ...
  test('update_AsProgrammableConfigDelegateV2', () {
    ...
    final decode =
        MetaplexTokenMetaDataUpdateAsProgrammableConfigDelegateV2Layout.fromBuffer(
          layout.toBytes(),
        );
    expect(decode.toBytes(), layout.toBytes());
  });
  ...
  test('update_AsProgrammableConfigItemDelegateV2', () {
    ...
    final decode =
        MetaplexTokenMetaDataUpdateAsProgrammableConfigItemDelegateV2Layout.fromBuffer(
          layout.toBytes(),
        );
    expect(decode.toBytes(), layout.toBytes());
  });
