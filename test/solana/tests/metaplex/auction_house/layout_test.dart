...
void _auctionHouseAccount() {
  ...
  test('auctionHouseAccount', () {
    ...
    expect(
      account.auctionHouseFeeAccount.address,
      '7Z95SWdaLeBp5hSAfoCUeyaeijtmbsVjhwnzV1cVpceN',
    );
    expect(
      account.auctionHouseTreasury.address,
    ...
    expect(
      account.auctioneerAddress.address,
      'sEac3HrsYnHSrbqx5BUBHpiXrBmJvhXMo9pMcYE4zYL',
    );
    expect(
      account.feeWithdrawalDestination.address,
...
void _auctioneerBuy() {
  test('auctioneerBuy', () {
    ...
    expect(
      layout.toHex(),
      '116a852ee5302dd0010203000000000000000400000000000000',
    );

    final decode = MetaplexAuctionHouseAuctioneerBuyLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
  test('auctioneerBuy_2', () {
    ...
    expect(
      layout.toHex(),
      '116a852ee5302dd0ffff40db1c040000000080f8a93200000000',
    );
...
void _auctioneerCancel() {
  test('auctioneerCancel', () {
    ...
    final decode = MetaplexAuctionHouseAuctioneerCancelLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _auctioneerPublicBuy() {
  test('auctioneerPublicBuy', () {
    ...
    expect(
      layout.toHex(),
      'ddef63f0562ed57e02041027000000000000b3b5560700000000',
    );
...
void _auctioneerSell() {
  test('auctioneerSell', () {
    ...
    final decode = MetaplexAuctionHouseAuctioneerSellLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _auctioneerWithdraw() {
  test('auctioneerWithdraw', () {
    final layout = MetaplexAuctionHouseAuctioneerWithdrawLayout(
      escrowPaymentBump: 255,
      amount: BigInt.from(12312332423),
    );
...
void _buy() {
  test('buy', () {
    ...
    expect(
      layout.toHex(),
      '66063d1201daebeaffffb3b5560700000000418d951400000000',
    );
...
void _cancel() {
  test('cancel', () {
    ...
    final decode = MetaplexAuctionHouseCancelLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _cancelBidReceipt() {
  test('cancelBidReceipt', () {
    ...
    final decode = MetaplexAuctionHouseCancelBidReceiptLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _closeEscrowAccount() {
  test('closeEscrowAccount', () {
    const layout = MetaplexAuctionHouseCloseEscrowAccountLayout(
      escrowPaymentBump: 255,
    );
...
void _deposit() {
  test('deposit', () {
    final layout = MetaplexAuctionHouseDepositLayout(
      ...
      amount: BigInt.from(12412341324),
    );
    expect(layout.toHex(), 'f223c68952e1f2b6c84c4cd5e302000000');

    final decode = MetaplexAuctionHouseDepositLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _executeSale() {
  test('executeSale', () {
    ...
    final decode = MetaplexAuctionHouseExecuteSaleLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _printBidReceipt() {
  test('printBidReceipt', () {
    ...
    final decode = MetaplexAuctionHousePrintBidReceiptLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _printListingReceipt() {
  test('printListingReceipt', () {
    const layout = MetaplexAuctionHousePrintListingReceiptLayout(
      receiptBump: 112,
    );
...
void _publicBuy() {
  test('printPurchaseReceipt', () {
    ...
    expect(
      layout.toHex(),
      'a954da232ace10abdedeb3db3e6205000000b3db3e6205000000',
    );

    final decode = MetaplexAuctionHousePublicBuyLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _updateAuctioneer() {
  test('updateAuctioneer', () {
    const layout = MetaplexAuctionHouseUpdateAuctioneerLayout(
      scopes: [AuthorityScope.buy, AuthorityScope.cancel, AuthorityScope.sell],
    );
    expect(layout.toHex(), '67ff50ea5e38a8d003000000010504');

    final decode = MetaplexAuctionHouseUpdateAuctioneerLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _withdraw() {
  test('withdraw', () {
    ...
    final decode = MetaplexAuctionHouseWithdrawLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _withdrawFromFee() {
  test('withdrawFromFee', () {
    ...
    final decode = MetaplexAuctionHouseWithdrawFromFeeLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _bidReceipt() {
  const owner = SolAddress.unchecked(
    'HcEjuQ7Eate3eyNBaZV2cwATcdAH8F7VGygVqkkoqUjf',
  );
  const account1 = SolAddress.unchecked(
    '57BYVwU1nZvkDkQZvqnNL71SE4jvegfGoEr6Eo6QgNyJ',
  );
  test('bidReceipt', () {
