...
void _changeMarket() {
  test('changeMarket', () {
    ...
    final decode = MetaplexFixedPriceSaleChangeMarketLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _claimResource() {
  test('claimResource', () {
    final layout = MetaplexFixedPriceSaleClaimResourceLayout(
      vaultOwnerBump: 123,
    );
    expect(layout.toHex(), '00a0a460ed764a1b7b');
    final decode = MetaplexFixedPriceSaleClaimResourceLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _closeMarket() {
  test('closeMarket', () {
    ...
    final decode = MetaplexFixedPriceSaleCloseMarketLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _createMarket() {
  test('createMarket', () {
    ...
    final decode = MetaplexFixedPriceSaleCreateMarketLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _createStore() {
  test('createStore', () {
    ...
    final decode = MetaplexFixedPriceSaleCreateStoreLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _resumeMarket() {
  test('resumeMarket', () {
    ...
    final decode = MetaplexFixedPriceSaleResumeMarketLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _suspendMarket() {
  test('suspendMarket', () {
    ...
    final decode = MetaplexFixedPriceSaleSuspendMarketLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _withdraw() {
  test('initSellingResource', () {
    ...
    final decode = MetaplexFixedPriceSaleWithdrawLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
