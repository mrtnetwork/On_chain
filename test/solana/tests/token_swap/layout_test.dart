...
void _swap() {
  test('swap', () {
    final layout = SPLTokenSwapSwapLayout(
      amountIn: BigInt.from(100),
      minimumAmountOut: BigInt.from(200),
    );
  ...
  test('swap_1', () {
    final layout = SPLTokenSwapSwapLayout(
      amountIn: BigInt.from(68646456),
      minimumAmountOut: BigInt.from(0),
    );
...
void _deposit() {
  test('deposit', () {
    ...
    expect(
      layout.toHex(),
      '026400000000000000c8000000000000002c01000000000000',
    );
  ...
  test('deposit_3', () {
    ...
    expect(
      layout.toHex(),
      '02010000000000000001000000000000000100000000000000',
    );
    final decode = SPLTokenSwapDepositLayout.fromBuffer(layout.toBytes());
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _withdraw() {
  test('withdraw', () {
    ...
    expect(
      layout.toHex(),
      '03010000000000000001000000000000000100000000000000',
    );
  ...
  test('withdraw_1', () {
    ...
    expect(
      layout.toHex(),
      '030000000000000000e8030000000000001027000000000000',
    );
    final decode = SPLTokenSwapWithdrawLayout.fromBuffer(layout.toBytes());
    expect(layout.toBytes(), decode.toBytes());
  });
  test('withdraw_3', () {
    ...
    expect(
      layout.toHex(),
      '030000000000000000000000000000000040420f0000000000',
    );
    final decode = SPLTokenSwapWithdrawLayout.fromBuffer(layout.toBytes());
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _depoitSingleToken() {
  test('depoitSingleToken', () {
    ...
    final decode = SPLTokenSwapDepositSingleTokenLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
...
void _withdrawSingle() {
  test('withdrawSingleToken', () {
    ...
    final decode = SPLTokenSwapWithdrawSingleTokenLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(layout.toBytes(), decode.toBytes());
  });
