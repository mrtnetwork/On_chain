...
void _updateValidatorListBalance() {
  test('updateValidatorListBalance', () {
    ...
    final decode = StakePoolUpdateValidatorListBalanceLayout.fromBuffer(
      layout.toBytes(),
    );
...
void _updateStakePoolBalance() {
  test('updateStakePoolBalance', () {
    ...
    final decode = StakePoolUpdateStakePoolBalanceLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _increaseValidatorStake() {
  test('increaseValidatorStake', () {
    final layout = StakePoolIncreaseValidatorStakeLayout(
      lamports: BigInt.from(15000),
      transientStakeSeed: BigInt.from(100),
    );
    expect(layout.toHex(), '04983a0000000000006400000000000000');
    final decode = StakePoolIncreaseValidatorStakeLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _increaseAdditionalValidatorStake() {
  test('_increaseAdditionalValidatorStake', () {
    ...
    expect(
      layout.toHex(),
      '13010000000000000001000000000000009600000000000000',
    );
  ...
  test('increaseValidatorStake_1', () {
    ...
    expect(
      layout.toHex(),
      '13dc05000000000000983a0000000000009600000000000000',
    );
    final decode = StakePoolIncreaseAdditionalValidatorStakeLayout.fromBuffer(
      layout.toBytes(),
    );
...
void _decreaseValidatorStake() {
  test('decreaseValidatorStake', () {
    ...
    final decode = StakePoolDecreaseValidatorStakeLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _decreaseAdditionalValidatorStake() {
  test('decreaseAdditionalValidatorStake', () {
    ...
    expect(
      layout.toHex(),
      '14dc05000000000000983a0000000000007b00000000000000',
    );
...
void _createTokenMetadata() {
  test('createTokenMetadata', () {
    ...
    final decode = StakePoolCreateTokenMetaDataLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _updateTokenMetadata() {
  test('updateTokenMetadata', () {
    ...
    final decode = StakePoolUpdateTokenMetaDataLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
