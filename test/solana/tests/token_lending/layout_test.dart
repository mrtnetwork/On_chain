...
void _depositReserveLiquidity() {
  test('depositReserveLiquidity', () {
    ...
    final decode = TokenLendingDepositReserveLiquidityLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _initLendingMarket() {
  test('initLendingMarket', () {
    ...
    final decode = TokenLendingInitLendingMarketLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _initObligation() {
  test('initObligation', () {
    ...
    final decode = TokenLendingInitObligationLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _liquidateObligation() {
  test('liquidateObligation', () {
    ...
    final decode = TokenLendingLiquidateObligationLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _redeemReserveCollateral() {
  test('redeemReserveCollateral', () {
    ...
    final decode = TokenLendingRedeemReserveCollateralLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _refreshObligation() {
  test('refreshObligation', () {
    ...
    final decode = TokenLendingRefreshObligationLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _refreshReserve() {
  test('refreshReserve', () {
    ...
    final decode = TokenLendingRefreshReserveLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
...
void _repayObligationLiquidity() {
  test('repayObligationLiquidity', () {
    ...
    final decode = TokenLendingRepayObligationLiquidityLayout.fromBuffer(
      layout.toBytes(),
    );
    expect(decode.toBytes(), layout.toBytes());
  });
