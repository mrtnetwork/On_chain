...
void main() {
  test('test1', () {
    ...
    final privateKey2 = SolanaPrivateKey.fromSeed(
      BytesUtils.fromHexString(
    ...
    expect(
      address,
      SolAddress.deserializeIAddress(bytes: address.encodeAsIAddress()),
    );
