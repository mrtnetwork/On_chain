...
void _testMultiKeyFailed() {
  test("Invalid MultiKey account", () {
    final privateKey1 = AptosED25519PrivateKey.fromBytes(
...
void _testMultiKey2() {
  test("MultiKey account 2", () {
    ...
    final privateKey2 = AptosED25519PrivateKey.fromBytes(
      List<int>.filled(32, 13),
    );
    final privateKey3 = AptosSecp256k1PrivateKey.fromBytes(
      List<int>.filled(32, 14),
    );
    final account = AptosMultiKeyAccountPublicKey(
      publicKeys: [
...
void _testMultiKey() {
  test("MultiKey account", () {
    ...
    final privateKey3 = AptosED25519PrivateKey.fromBytes(
      List<int>.filled(32, 14),
    );
    final account = AptosMultiKeyAccountPublicKey(
      publicKeys: [
...
void _testMultiEdAccount2() {
  test("Multi Ed25519 account 3", () {
    ...
    final account = AptosMultiEd25519AccountPublicKey(
      publicKeys: [
        privateKey1.publicKey,
        privateKey2.publicKey,
        privateKey3.publicKey,
    ...
    final decode = AptosMultiEd25519AccountPublicKey.deserialize(
      account.toBcs(),
    );
    expect(decode.toBcsHex(), account.toBcsHex());
    expect(
    ...
    final fromBytes = AptosMultiEd25519AccountPublicKey.fromBytes(
      account.toBytes(),
    );
...
void _testMultiEdAccount() {
  test("Multi Ed25519 account 2", () {
    ...
    final addr = AptosAddress(
      "bca0f886d39361116fc4dbe2c80f9ca7edae425030df03b4a158fd448faac91b",
    );
    expect(account.toAddress(), addr);
    expect(
      AptosAddress.deserializeIAddress(bytes: addr.encodeAsIAddress()),
      addr,
    );
...
void _testEd25519LegacyAccount() {
  test("Ed25519 legacy account", () {
    final privateKey = AptosED25519PrivateKey.fromBytes(
      List<int>.filled(32, 12),
    );
...
void _testSignleKeySecp256k1() {
  test("Secp256k1 singleKey account", () {
    final privateKey = AptosSecp256k1PrivateKey.fromBytes(
      List<int>.filled(32, 12),
    );
    final account = AptosSingleKeyAccountPublicKey(privateKey.publicKey);
    expect(
