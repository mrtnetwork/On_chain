...
void _test() {
  test("aptos Ed25519 signing test", () {
    ...
    expect(
      BytesUtils.toHexString(sig.toBytes()),
    ...
    expect(
      key.publicKey.verifySignature(message: [0], signature: sig.toBcs()),
      true,
    );
  });
  ...
  test("aptos MultiED signing test", () {
    ...
    final key = AptosMultiEd25519Account(
      publicKey: AptosMultiEd25519AccountPublicKey(
        publicKeys: [privateKey1.publicKey, privateKey2.publicKey],
        threshold: 2,
      ),
