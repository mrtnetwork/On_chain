...
void _testAbi() {
  test("aptos module abi parsing arguments", () {
    ...
    final function = abi.exposedFunctions.firstWhere(
      (e) => e.name == 'private_arguments',
    );
    ...
    final entryArguments = AptosFunctionEntryArgumentUtils.parseArguments(
      ...
      values: [
        ...
        [0, 1, 2, _maxU64 - BigInt.from(2), _maxU64 - BigInt.from(1), _maxU64],
        [
          0,
          1,
          2,
  ...
  test("aptos module abi parsing arguments", () {
    final AptosApiMoveModule abi = AptosApiMoveModule.fromJson(_abiJson);
    final function = abi.exposedFunctions.firstWhere(
      (e) => e.name == 'public_arguments_multiple_signers',
    );
