...
void _simpleTransaction() {
  test("Simple Transaction serialization", () {
    final script = AptosScript(
      ...
      arguments: [MoveU8(12), MoveU64(BigInt.parse("2500000000000"))],
    );
  ...
  test("signed transaction", () {
    AptosTransactionAuthenticatorMultiAgent getAuth() {
      AptosAccountAuthenticatorSingleKey secondAuth() {
        final publicKey =
            AptosSecp256k1PrivateKey.fromBytes(
      ...
      final msigAccount = AptosMultiKeyAccountPublicKey(
        publicKeys: [
          AptosSecp256k1PrivateKey.fromBytes(
            List<int>.filled(32, 12),
          ).publicKey,
      ...
      final auth = AptosAccountAuthenticatorMultiKey(
        ...
        signature: AptosMultiKeySignature(
          signatures: [
