...
class Permission extends TronProtocolBufferImpl {
  ...
  factory Permission.fromJson(Map<String, dynamic> json) {
    return Permission(
      ...
      id: json.valueAsInt("id"),
      permissionName: json.valueAs("permission_name"),
      operations: json.valueAsBytes("operations"),
      keys:
          json
              .valueAsList<List<Map<String, dynamic>>?>("keys")
              ?.map((e) => TronKey.fromJson(e))
              .toList(),
      parentId: json.valueAsInt("parent_id"),
      threshold: json.valueAsBigInt("threshold"),
    );
  }
