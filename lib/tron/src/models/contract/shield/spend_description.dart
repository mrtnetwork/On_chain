...
class SpendDescription extends TronProtocolBufferImpl {
  ...
  factory SpendDescription.fromJson(Map<String, dynamic> json) {
    return SpendDescription(
      ...
      spendAuthoritySignature: BytesUtils.tryFromHexString(
        json['spend_authority_signature'],
      ),
    );
  }
  ...
  SpendDescription({
    ...
    List<int>? spendAuthoritySignature,
       ...
       spendAuthoritySignature = BytesUtils.tryToBytes(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'spend_authority_signature': BytesUtils.tryToHexString(
        spendAuthoritySignature,
      ),
