class BlockfrostMethods {
  ...
  static const BlockfrostMethods rootEndpoint = BlockfrostMethods._(
    'Root endpoint',
    '/',
  );
  ...
  static const BlockfrostMethods backendHealthStatus = BlockfrostMethods._(
  ...
  static const BlockfrostMethods currentBackendTime = BlockfrostMethods._(
    'Current backend time',
    '/health/clock',
  );

  /// History of your Blockfrost usage metrics in the past 30 days.
  static const BlockfrostMethods blockFrostUsageMetric = BlockfrostMethods._(
  ...
  static const BlockfrostMethods specificAddress = BlockfrostMethods._(
    'Specific address',
    '/addresses/:address',
  );
  ...
  static const BlockfrostMethods addressDetails = BlockfrostMethods._(
    'Address details',
    '/addresses/:address/total',
  );

  /// UTXOs of the address.
  static const BlockfrostMethods addressUTXOs = BlockfrostMethods._(
    'Address UTXOs',
  ...
  static const BlockfrostMethods assets = BlockfrostMethods._(
    'Assets',
    '/assets',
  );

  /// Information about a specific asset.
  static const BlockfrostMethods specificAsset = BlockfrostMethods._(
    'Specific asset',
    '/assets/:asset',
  );

  /// History of a specific asset.
  static const BlockfrostMethods assetHistory = BlockfrostMethods._(
    'Asset history',
    '/assets/:asset/history',
  );

  /// List of a specific asset transactions.
  static const BlockfrostMethods assetTransactions = BlockfrostMethods._(
    'Asset transactions',
    '/assets/:asset/transactions',
  );

  /// List of a addresses containing a specific asset.
  static const BlockfrostMethods assetAddresses = BlockfrostMethods._(
    'Asset addresses',
  ...
  static const BlockfrostMethods latestBlock = BlockfrostMethods._(
    'Latest block',
    '/blocks/latest',
  );
  ...
  static const BlockfrostMethods lastBlockTransactions = BlockfrostMethods._(
    'Latest block transactions',
    '/blocks/latest/txs',
  );

  /// Return the content of a requested block.
  static const BlockfrostMethods specificBlock = BlockfrostMethods._(
    'Specific block',
  ...
  static const BlockfrostMethods blockTransactions = BlockfrostMethods._(
    'Block transactions',
  ...
  static const BlockfrostMethods latestEpoch = BlockfrostMethods._(
    'Latest epoch',
    '/epochs/latest',
  );
  ...
  static const BlockfrostMethods specificEpoch = BlockfrostMethods._(
    'Specific epoch',
    '/epochs/:number',
  );

  /// Return the list of epochs following a specific epoch.
  static const BlockfrostMethods listingOfNextEpoches = BlockfrostMethods._(
  ...
  static const BlockfrostMethods stakeDistribution = BlockfrostMethods._(
    'Stake distribution',
  ...
  static const BlockfrostMethods blockDistribution = BlockfrostMethods._(
    'Block distribution',
  ...
  static const BlockfrostMethods protocolParameters = BlockfrostMethods._(
    'Protocol parameters',
    '/epochs/:number/parameters',
  );

  /// Return the information about blockchain genesis.
  static const BlockfrostMethods blockchainGenesis = BlockfrostMethods._(
    'Blockchain genesis',
    '/genesis',
  );
  ...
  static const BlockfrostMethods mempool = BlockfrostMethods._(
    'Mempool',
    '/mempool',
  );
  ...
  static const BlockfrostMethods mempoolByAddress = BlockfrostMethods._(
    'Mempool by address',
  ...
  static const BlockfrostMethods networkInformation = BlockfrostMethods._(
    'Network information',
    '/network',
  );
  ...
  static const BlockfrostMethods listOfStakePools = BlockfrostMethods._(
    'List of stake pools',
    '/pools',
  );
  ...
  static const BlockfrostMethods listOfRetiredStakePools = BlockfrostMethods._(
    'List of retired stake pools',
    '/pools/retired',
  );

  /// List of stake pools retiring in the upcoming epochs.
  static const BlockfrostMethods listOfRetiringStakePools = BlockfrostMethods._(
    'List of retiring stake pools',
    '/pools/retiring',
  );

  /// Pool information.
  static const BlockfrostMethods specificStakePool = BlockfrostMethods._(
    'Specific stake pool',
    '/pools/:pool_id',
  );

  /// History of stake pool parameters over epochs.
  static const BlockfrostMethods stakePoolHistory = BlockfrostMethods._(
    'Stake pool history',
    '/pools/:pool_id/history',
  );

  /// Stake pool registration metadata.
  static const BlockfrostMethods stakePoolMetadata = BlockfrostMethods._(
    'Stake pool metadata',
    '/pools/:pool_id/metadata',
  );

  /// Relays of a stake pool.
  static const BlockfrostMethods stakePoolRelays = BlockfrostMethods._(
    'Stake pool relays',
  ...
  static const BlockfrostMethods stakePoolBlocks = BlockfrostMethods._(
    'Stake pool blocks',
    '/pools/:pool_id/blocks',
  );

  /// List of certificate updates to the stake pool.
  static const BlockfrostMethods stakePoolUpdates = BlockfrostMethods._(
    'Stake pool updates',
    '/pools/:pool_id/updates',
  );

  /// List of scripts.
  static const BlockfrostMethods scripts = BlockfrostMethods._(
    'Scripts',
    '/scripts',
  );

  /// Information about a specific script.
  static const BlockfrostMethods specificScript = BlockfrostMethods._(
    'Specific script',
    '/scripts/:script_hash',
  );

  /// JSON representation of a timelock script
  static const BlockfrostMethods scriptJson = BlockfrostMethods._(
    'Script JSON',
    '/scripts/:script_hash/json',
  );

  /// CBOR representation of a plutus script.
  static const BlockfrostMethods scriptCBOR = BlockfrostMethods._(
    'Script CBOR',
  ...
  static const BlockfrostMethods datumValue = BlockfrostMethods._(
    'Datum value',
  ...
  /// Return content of the requested transaction.
  static const BlockfrostMethods specificTransaction = BlockfrostMethods._(
    'Specific transaction',
    '/txs/:hash',
  );

  static const BlockfrostMethods transactionCbor = BlockfrostMethods._(
    'Specific transaction as cbor',
    '/txs/:hash/cbor',
  );

  /// Return the inputs and UTXOs of the specific transaction.
  static const BlockfrostMethods transactionUTXOs = BlockfrostMethods._(
    'Transaction UTXOs',
    '/txs/:hash/utxos',
  );
  ...
  static const BlockfrostMethods transactionWithdrawal = BlockfrostMethods._(
    'Transaction withdrawal',
    '/txs/:hash/withdrawals',
  );

  /// Obtain information about Move Instantaneous Rewards (MIRs) of a specific transaction.
  static const BlockfrostMethods transactionMIRs = BlockfrostMethods._(
    'Transaction MIRs',
    '/txs/:hash/mirs',
  );
  ...
  static const BlockfrostMethods
  transactionStakePoolRegistrationAndUpdateCertificates = BlockfrostMethods._(
  ...
  static const BlockfrostMethods transactionMetadata = BlockfrostMethods._(
  ...
  static const BlockfrostMethods transactionRedeemers = BlockfrostMethods._(
    'Transaction redeemers',
    '/txs/:hash/redeemers',
  );

  /// Submit an already serialized transaction to the network.
  static const BlockfrostMethods submitTransaction = BlockfrostMethods._(
  ...
  static const BlockfrostMethods specificNutlinkAddress = BlockfrostMethods._(
  ...
  static const BlockfrostMethods specificTickerForAnAddress =
      BlockfrostMethods._(
  ...
  /// List of records of a specific ticker
  static const BlockfrostMethods specificTicker = BlockfrostMethods._(
    'Specific ticker',
