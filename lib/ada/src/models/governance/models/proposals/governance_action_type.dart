...
class GovernanceActionType with InternalCborSerialization {
  ...
  static const GovernanceActionType noConfidenceAction = GovernanceActionType._(
    'NoConfidenceAction',
    3,
  );
  ...
  static const GovernanceActionType infoAction = GovernanceActionType._(
    'InfoAction',
    6,
  );
  ...
  static GovernanceActionType fromValue(int? value) {
    return values.firstWhere(
      ...
      orElse: () => throw ItemNotFoundException(name: "GovernanceActionType"),
    );
  }
