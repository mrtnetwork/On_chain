...
class Vkeywitness with ADASerialization implements ADABaseTransactionWitness {
  ...
  @override
  CborObject toCbor() {
    return CborListValue.definite([vKey.toCbor(), signature.toCbor()]);
  }
  ...
  operator ==(other) {
    ...
    return vKey == other.vKey && signature == other.signature;
  }

  @override
  int get hashCode => HashCodeGenerator.generateHashCode([vKey, signature]);
}
