...
class TransactionMetadataType with InternalCborSerialization {
  ...
  static const TransactionMetadataType metadataMap = TransactionMetadataType._(
    0,
    'Map',
  );

  /// Represents metadata type for a metadata list.
  static const TransactionMetadataType metadataList = TransactionMetadataType._(
    1,
    'List',
  );

  /// Represents metadata type for an integer metadata.
  static const TransactionMetadataType metadataInt = TransactionMetadataType._(
    2,
    'Int',
  );
  ...
  static const TransactionMetadataType metadataText = TransactionMetadataType._(
    4,
    'String',
  );
  ...
  static TransactionMetadataType fromName(String? name) {
    return values.firstWhere(
      ...
      orElse:
          () => throw ItemNotFoundException(name: "TransactionMetadataType"),
    );
  }
