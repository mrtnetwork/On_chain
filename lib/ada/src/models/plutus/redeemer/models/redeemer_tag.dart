...
class RedeemerTag with InternalCborSerialization {
  ...
  static const RedeemerTag vote = RedeemerTag._('Vote', 4);
  static const RedeemerTag votingProposal = RedeemerTag._('VotingProposal', 5);
  static const List<RedeemerTag> values = [
    spend,
    mint,
    cert,
    reward,
