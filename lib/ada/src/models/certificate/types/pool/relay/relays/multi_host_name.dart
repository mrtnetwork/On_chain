...
class MultiHostName extends Relay {
  ...
  factory MultiHostName.deserialize(CborListValue cbor) {
    RelayType.deserialize(cbor.getIndex(0), validate: RelayType.multiHostName);
    return MultiHostName(dnsName: cbor.getIndex(1));
  }
  ...
  @override
  CborObject toCbor() {
    return CborListValue.fixedLength([type.toCbor(), CborStringValue(dnsName)]);
  }
