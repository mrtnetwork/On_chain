...
class CertificateType with InternalCborSerialization {
  ...
  static const CertificateType stakeRegistration = CertificateType._(
    'StakeRegistration',
    0,
  );

  /// Certificate type for stake deregistration.
  static const CertificateType stakeDeregistration = CertificateType._(
    'StakeDeregistration',
    1,
  );

  /// Certificate type for stake delegation.
  static const CertificateType stakeDelegation = CertificateType._(
    'StakeDelegation',
    2,
  );

  /// Certificate type for pool registration.
  static const CertificateType poolRegistration = CertificateType._(
    'PoolRegistration',
    3,
  );

  /// Certificate type for pool retirement.
  static const CertificateType poolRetirement = CertificateType._(
    'PoolRetirement',
    4,
  );

  /// Certificate type for genesis key delegation.
  static const CertificateType genesisKeyDelegation = CertificateType._(
    'GenesisKeyDelegation',
    5,
  );

  /// Certificate type for moving instantaneous rewards.
  static const CertificateType moveInstantaneousRewardsCert = CertificateType._(
    'MoveInstantaneousRewardsCert',
    6,
  );

  /// Conway: Stake registration certificate.
  static const CertificateType stakeRegistrationConway = CertificateType._(
    'StakeRegistrationConway',
    7,
  );

  /// Conway: Stake deregistration certificate.
  static const CertificateType stakeDeregistrationConway = CertificateType._(
    'StakeDeregistrationConway',
    8,
  );

  /// Conway: Vote delegation certificate.
  static const CertificateType voteDelegation = CertificateType._(
    'VoteDelegation',
    9,
  );

  /// Conway: Stake and vote delegation certificate.
  static const CertificateType stakeAndVoteDelegation = CertificateType._(
  ...
  static const CertificateType committeeHotAuth = CertificateType._(
    'CommitteeHotAuth',
    14,
  );

  /// Conway: Committee cold key resignation certificate.
  static const CertificateType committeeColdResign = CertificateType._(
    'CommitteeColdResign',
    15,
  );

  /// Conway: DRep (Delegate Representative) registration certificate.
  static const CertificateType dRepRegistration = CertificateType._(
    'DRepRegistration',
    16,
  );

  /// Conway: DRep deregistration certificate.
  static const CertificateType dRepDeregistration = CertificateType._(
    'DRepDeregistration',
    17,
  );
  ...
  factory CertificateType.deserialize(
    CborIntValue cbor, {
  ...
  static CertificateType fromValue(int? value) {
    return values.firstWhere(
      ...
      orElse: () => throw ItemNotFoundException(name: "CertificateType"),
    );
  }
