...
class EthereumMethods {
  ...
  static const EthereumMethods getBlockNumber = EthereumMethods(
    'eth_blockNumber',
  );
  static const EthereumMethods getBalance = EthereumMethods('eth_getBalance');
  static const EthereumMethods getStorageAt = EthereumMethods(
    'eth_getStorageAt',
  );
  static const EthereumMethods getTransactionCount = EthereumMethods(
  ...
  static const EthereumMethods signTransaction = EthereumMethods(
    'eth_signTransaction',
  );
  static const EthereumMethods ethSubscribe = EthereumMethods('eth_subscribe');
  static const EthereumMethods ethUnsubscribe = EthereumMethods(
    'eth_unsubscribe',
  );
  static const EthereumMethods sendTransaction = EthereumMethods(
    'eth_sendTransaction',
  );
  static const EthereumMethods sendRawTransaction = EthereumMethods(
  ...
  static const EthereumMethods getTransactionReceipt = EthereumMethods(
  ...
  static const EthereumMethods compileSerpent = EthereumMethods(
    'eth_compileSerpent',
  );
  static const EthereumMethods newFilter = EthereumMethods('eth_newFilter');

  static const EthereumMethods newBlockFilter = EthereumMethods(
    'eth_newBlockFilter',
  );
  static const EthereumMethods newPendingTransactionFilter = EthereumMethods(
    'eth_newPendingTransactionFilter',
  );
  static const EthereumMethods uninstallFilter = EthereumMethods(
    'eth_uninstallFilter',
  );
  static const EthereumMethods getFilterChanges = EthereumMethods(
    'eth_getFilterChanges',
  );

  static const EthereumMethods getFilterLogs = EthereumMethods(
    'eth_getFilterLogs',
  );
  ...
  static const EthereumMethods submitHashrate = EthereumMethods(
    'eth_submitHashrate',
  );
  static const EthereumMethods getFeeHistory = EthereumMethods(
    'eth_feeHistory',
  );
  static const EthereumMethods getPendingTransactions = EthereumMethods(
    'eth_pendingTransactions',
  );
  static const EthereumMethods requestAccounts = EthereumMethods(
    'eth_requestAccounts',
  );
  ...
  static const EthereumMethods createAccessList = EthereumMethods(
    'eth_createAccessList',
  );
  static const EthereumMethods signTypedData = EthereumMethods(
    'eth_signTypedData',
  );
