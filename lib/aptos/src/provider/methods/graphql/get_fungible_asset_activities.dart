...
class AptosGraphQLRequestGetFungibleAssetActivities
    extends
        AptosGraphQLRequest<
          List<AptosGraphQLFungibleAssetActivity>,
          Map<String, dynamic>
        > {
  ...
  List<AptosGraphQLFungibleAssetActivity> onResonse(
    ...
    return result
        .valueEnsureAsList<Map<String, dynamic>>("fungible_asset_activities")
