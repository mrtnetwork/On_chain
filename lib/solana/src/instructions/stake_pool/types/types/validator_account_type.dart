...
class ValidatorAccountType {
  ...
  static const ValidatorAccountType preferred = ValidatorAccountType._(
    'Preferred',
    0,
  );
  static const ValidatorAccountType active = ValidatorAccountType._(
    'Active',
    1,
  );
  static const ValidatorAccountType transient = ValidatorAccountType._(
    'Transient',
    2,
  );
  static const ValidatorAccountType reserve = ValidatorAccountType._(
    'Reserve',
    3,
  );
