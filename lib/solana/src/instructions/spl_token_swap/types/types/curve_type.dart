...
class SPLTokenSwapCurveType {
  ...
  /// token_b_amount
  static const SPLTokenSwapCurveType constantProduct = SPLTokenSwapCurveType._(
    'ConstantProduct',
    0,
  );

  /// Flat line, always providing 1:1 from one token to another
  static const SPLTokenSwapCurveType constantPrice = SPLTokenSwapCurveType._(
    'ConstantPrice',
    1,
  );

  /// Offset curve, like Uniswap, but the token B side has a faked offset
  static const SPLTokenSwapCurveType offset = SPLTokenSwapCurveType._(
    'Offset',
    2,
  );
