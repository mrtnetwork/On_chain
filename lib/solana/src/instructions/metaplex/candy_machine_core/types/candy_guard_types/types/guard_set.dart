...
class GuardSet extends BorshLayoutSerializable {
  ...
  factory GuardSet.fromJson(Map<String, dynamic> json) {
    return GuardSet(
      ...
      freezeTokenPayment: FreezeTokenPayment.fromJson(
        json['freezeTokenPayment'],
      ),
  ...
  static StructLayout get staticLayout => LayoutConst.struct([
    ...
    LayoutConst.optional(
      FreezeSolPayment.staticLayout,
      property: 'freezeSolPayment',
    ),
    LayoutConst.optional(
      FreezeTokenPayment.staticLayout,
