...
class AuthorityScope {
  ...
  static const AuthorityScope deposit = AuthorityScope(
    name: 'Deposit',
    value: 0,
  );
  static const AuthorityScope buy = AuthorityScope(name: 'Buy', value: 1);
  static const AuthorityScope publicBuy = AuthorityScope(
    name: 'PublicBuy',
    value: 2,
  );
  static const AuthorityScope executeSale = AuthorityScope(
    name: 'ExecuteSale',
    value: 3,
  );
  ...
  static const AuthorityScope withdraw = AuthorityScope(
    name: 'Withdraw',
    value: 6,
  );
