...
class ConcurrentMerkleTree extends BorshLayoutSerializable {
  ...
  static StructLayout staticLayout({
    ...
    LayoutConst.array(
      ChangeLog.staticLayout(maxDepth: maxDepth),
      maxBufferSize,
      property: 'changeLogs',
    ),
    LayoutConst.wrap(
      Path.staticLayout(maxDepth: maxDepth),
  ...
  StructLayout get layout => staticLayout(
    maxBufferSize: changeLogs.length,
    maxDepth: rightMostPath.proof.length,
  );
