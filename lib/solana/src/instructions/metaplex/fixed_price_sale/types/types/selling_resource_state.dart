...
class SellingResourceState {
  ...
  static const SellingResourceState uninitialized = SellingResourceState._(
    'Uninitialized',
    0,
  );
  static const SellingResourceState created = SellingResourceState._(
    'Created',
    1,
  );
  static const SellingResourceState inUse = SellingResourceState._('InUse', 2);
  static const SellingResourceState exhausted = SellingResourceState._(
    'Exhausted',
    3,
  );
  static const SellingResourceState stopped = SellingResourceState._(
    'Stopped',
    4,
  );
