...
class MetadataDelegateRole {
  ...
  static const MetadataDelegateRole authorityItem = MetadataDelegateRole._(
    'AuthorityItem',
    0,
    'authority_item_delegate',
  );
  static const MetadataDelegateRole collection = MetadataDelegateRole._(
    'Collection',
    1,
    'collection_delegate',
  );
  static const MetadataDelegateRole use = MetadataDelegateRole._(
    'Use',
    2,
    'use_delegate',
  );
  static const MetadataDelegateRole data = MetadataDelegateRole._(
    'Data',
    3,
    'data_delegate',
  );
  ...
  static const MetadataDelegateRole dataItem = MetadataDelegateRole._(
    'DataItem',
    5,
    'data_item_delegate',
  );
  static const MetadataDelegateRole collectionItem = MetadataDelegateRole._(
    'CollectionItem',
    6,
