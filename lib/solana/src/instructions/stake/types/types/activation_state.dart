...
class StakeActivationState {
  ...
  static const StakeActivationState active = StakeActivationState._(
    'Active',
    0,
  );
  static const StakeActivationState inactive = StakeActivationState._(
    'Inactive',
    1,
  );
  static const StakeActivationState activating = StakeActivationState._(
    'Activating',
    2,
  );
  static const StakeActivationState deactivating = StakeActivationState._(
    'Deactivating',
    3,
  );
