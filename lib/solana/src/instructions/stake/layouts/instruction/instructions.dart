...
class StakeProgramInstruction implements ProgramLayoutInstruction {
  ...
  static const StakeProgramInstruction initialize = StakeProgramInstruction(
    0,
    'Initialize',
  );
  static const StakeProgramInstruction authorize = StakeProgramInstruction(
    1,
    'Authorize',
  );
  static const StakeProgramInstruction delegate = StakeProgramInstruction(
    2,
    'Delegate',
  );
  static const StakeProgramInstruction split = StakeProgramInstruction(
    3,
    'Split',
  );
  static const StakeProgramInstruction withdraw = StakeProgramInstruction(
    4,
    'Withdraw',
  );
  static const StakeProgramInstruction deactivate = StakeProgramInstruction(
    5,
    'Deactivate',
  );
  static const StakeProgramInstruction merge = StakeProgramInstruction(
    7,
    'Merge',
  );
