...
void main() async {
  ...
  final reclaimedAddr = TronAddress("TTQ5iiGK45w3Za5R8jBjYDHEywoZZgGt8j");
  ...
  /// create contract
  final contract = UnDelegateResourceContract(
    ownerAddress: ownerAddress,
    balance: TronHelper.toSun("1"),
    receiverAddress: reclaimedAddr,
    resource: ResourceCode.energy,
  );

  /// validate transacation and got required data like block hash and ....
  final request = await rpc.request(TronRequestUndelegateResource.fromContract(
    contract,
  ));
  ...
  /// energy
  /// https://shasta.tronscan.org/#/transaction/18fa6ff86f7ed9d8e5a0dc6d2490120d1c46c6adbff8f61269fa60c4cb8d667e
}
